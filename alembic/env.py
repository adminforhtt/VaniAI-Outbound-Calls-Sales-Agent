...
from app.models.core import Tenant, User, Campaign, Lead, CallLog, Subscription, ScriptVersion
...
DATABASE_URL = os.environ.get("DATABASE_URL", "sqlite:///./twilio_agent.db")
